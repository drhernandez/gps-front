...
jest.mock("../../api/services/vehiclesService", () => ({ searchVehicles: jest.fn(), getTrackings: jest.fn() }));
...
describe('HeatMap component', () => {
  beforeEach(async () => {
    ...
    await VehiclesService.getTrackings.mockImplementation(() => {
  ...
  it("should get trackings of selected vehicle", async () => {
    ...
    expect(wrapper.find('CardBody').props().children.props.trackings).toHaveLength(trackingsMock.length);
  });
});